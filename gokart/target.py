...
class TargetOnKart(luigi.Target):
    ...
    def dump(self, obj, lock_at_dump: bool = True, task_params: Optional[dict[Any, str]] = None, user_provided_labels: Optional[dict[Any, Any]] = None) -> None:
        if lock_at_dump:
    ...
    @abstractmethod
    def _dump(self, obj, task_params: Optional[dict[Any, str]] = None, user_provided_labels: Optional[dict[Any, str]] = None) -> None:
        pass
...
class SingleFileTarget(TargetOnKart):
    ...
    def _dump(self, obj, task_params: Optional[dict[Any, str]] = None, user_provided_labels: Optional[dict[Any, Any]] = None) -> None:
